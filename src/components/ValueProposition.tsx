    ...
    <section id="value-prop" className="py-16 md:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-[#13141F] p-8 rounded-xl shadow-sm border border-[#2A2D3E] hover-lift">
            <div className="h-12 w-12 bg-[#1E1F2E] rounded-lg flex items-center justify-center mb-6">
